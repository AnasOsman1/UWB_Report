...
* Performing the accuracy vs Area experiment for the second scenario in the garage in absolute line of sight, where the points were the 4 anchors where placed away from the static pillars in the garage and above the outer line of the parking space lining in absolute line of sight of the pathway. The experiment was performed to understand and compute how the accuracy is of the dwm1001 module is affected by scaling of the area 3 times. The first experiment was performed in a non-absolute line of sight condition where the anchors where placed on side pillars of the garage surrounded by cars. The latter experiment aims to verify and ensure that the measurement error could be minimized if the anchors are placed away from objects that would impose a magnification of the Fresnel effect.
...
![Configuration of anchor 1 and 4]('IMG-2141.jpeg'){#id .class width=600 height=600px}


![Initiator Anchor Configuration]('IMG-2139.jpeg'){#id .class width=600 height=600px}

![Front view of the rod usde to fix the anchor]('IMG-2140.jpeg'){#id .class width=600 height=600px}


![Side view of the Rod used to fix the anchors]('IMG-2142.jpeg'){#id .class width=600 height=600px}
...
p <- ggplot()+
  ...
  theme_bw()+
  theme(
    text = element_text(size = 12, color = "black", face = "bold",family="Comic Sans MS"),
    axis.title.x  =  element_text(color = "blue", size = 12, face = "bold"),
    axis.title.y  =  element_text(color = "#993333", size = 12, face = "bold"))+
  labs(
    title =  "Root Mean Square Error of All the Data in X vs Area Size",
...
O <- ggplot()+
  ...
  theme(
    ...
    axis.title.y  =  element_text(color = "#993333", size = 12, face = "bold"))+
  labs(
    title =  "Root Mean Square Error of All the Data in Y vs Area Size",
...
```{r include=FALSE}
p1 <- ggplot()+
  geom_point(data = df1, aes(x = "1", y= X_RMSE, color = "Point1"),shape = 3)+
  geom_point(data = df2, aes(x = "2", y= X_RMSE, color = "Point2"),shape = 3)+
  geom_point(data = df3, aes(x = "3", y= X_RMSE, color = "Point3"),shape = 3)+
  geom_point(data = df4, aes(x = "1", y= X_RMSE, color = "Point1"),shape = 3)+
  geom_point(data = df5, aes(x = "2", y= X_RMSE, color = "Point2"),shape = 3)+
  geom_point(data = df6, aes(x = "3", y= X_RMSE, color = "Point3"),shape = 3)+
  geom_point(data = df7, aes(x = "1", y= X_RMSE, color = "Point1"),shape = 3)+
  geom_point(data = df8, aes(x = "2", y= X_RMSE, color = "Point2"),shape = 3)+
  geom_point(data = df9, aes(x = "3", y= X_RMSE, color = "Point3"),shape = 3)+
  theme_bw(base_family = "Times")+
  theme(
    text = element_text(size = 12, color = "black", face = "bold", family="Comic Sans MS"),
    axis.title.x  =  element_text(color = "blue", size = 12, face = "bold"),
    axis.title.y  =  element_text(color = "#993333", size = 12, face = "bold"))+
  labs(
    title =  "Total Root Mean Square Error of All the Data in X vs Tag Position",
    y = "Total Root Mean Square Error X in (meters)",
    x = "Tag Position")


p2 <- ggplot()+
  geom_point(data = df1, aes(x = "1", y= Y_RMSE, color = "Point1"),shape = 3)+
  geom_point(data = df2, aes(x = "2", y= Y_RMSE, color = "Point2"),shape = 3)+
  geom_point(data = df3, aes(x = "3", y= Y_RMSE, color = "Point3"),shape = 3)+
  geom_point(data = df4, aes(x = "1", y= Y_RMSE, color = "Point1"),shape = 3)+
  geom_point(data = df5, aes(x = "2", y= Y_RMSE, color = "Point2"),shape = 3)+
  geom_point(data = df6, aes(x = "3", y= Y_RMSE, color = "Point3"),shape = 3)+
  geom_point(data = df7, aes(x = "1", y= Y_RMSE, color = "Point1"),shape = 3)+
  geom_point(data = df8, aes(x = "2", y= Y_RMSE, color = "Point2"),shape = 3)+
  geom_point(data = df9, aes(x = "3", y= Y_RMSE, color = "Point3"),shape = 3)+
  theme_bw(base_family = "Times")+
  theme(
    text = element_text(size = 12, color = "black", face = "bold", family="Comic Sans MS"),
    axis.title.x  =  element_text(color = "blue", size = 12, face = "bold"),
    axis.title.y  =  element_text(color = "#993333", size = 12, face = "bold"))+
  labs(
    title =  "Total Root Mean Square Error of All the Data in Y vs Tag Position",
...
* The comparison between the ground truth measurement and the UWB reading is show in this figure. 
...
Comp <- ggplot()+
  geom_point(data = df_list1, aes(x= x, y=y, color= "Area_1"), shape= 1)+
  geom_point(data = df_list2, aes(x= x, y=y, color= "Area_1"), shape= 1)+
  geom_point(data = df_list3, aes(x= x, y=y, color= "Area_1"), shape= 1)+
  geom_point(data = df_list4, aes(x= x, y=y, color= "Area_2"), shape= 1)+
  geom_point(data = df_list5, aes(x= x, y=y, color= "Area_2"), shape= 1)+
  geom_point(data = df_list6, aes(x= x, y=y, color= "Area_2"), shape= 1)+
  geom_point(data = df_list7, aes(x= x, y=y, color= "Area_3"), shape= 1)+
  geom_point(data = df_list8, aes(x= x, y=y, color= "Area_3"), shape= 1)+
  geom_point(data = df_list9, aes(x= x, y=y, color= "Area_3"), shape= 1)+
  geom_point(data = Area1, aes(x= Point1[1], y=Point1[2], color= "Area_1"), shape= 3)+
  geom_point(data = Area1, aes(x= Point2[1], y=Point2[2], color= "Area_1"), shape= 3)+
  geom_point(data = Area1, aes(x= Point3[1], y=Point3[2], color= "Area_1"), shape= 3)+
  geom_point(data = Area2, aes(x= Point1[1], y=Point1[2], color= "Area_2"), shape= 3)+
  geom_point(data = Area2, aes(x= Point2[1], y=Point2[2], color= "Area_2"), shape= 3)+
  geom_point(data = Area2, aes(x= Point3[1], y=Point3[2], color= "Area_2"), shape= 3)+
  geom_point(data = Area3, aes(x= Point1[1], y=Point1[2], color= "Area_3"), shape= 3)+
  geom_point(data = Area3, aes(x= Point2[1], y=Point2[2], color= "Area_3"), shape= 3)+
  geom_point(data = Area3, aes(x= Point3[1], y=Point3[2], color= "Area_3"), shape= 3)+
  theme_bw()+
  theme(
    text = element_text(size = 12, color = "black", face = "bold", family="Comic Sans MS"),
    axis.title.x  =  element_text(color = "blue", size = 12, face = "bold"),
    axis.title.y  =  element_text(color = "#993333", size = 12, face = "bold"))+
  labs(
    title = "      Ground Truth Measurment (Laser Tool) vs UWB Reading",
...
a1 <- ggplot()+
  ...
  theme_bw()+
  theme(
    text = element_text(size = 10, color = "black", face = "bold", family="Comic Sans MS"),
    axis.title.x  =  element_text(color = "blue", size = 10, face = "bold"),
    axis.title.y  =  element_text(color = "#993333", size = 10, face = "bold"))+
  labs(
    title = "",
    y = "Total RMS Error in Y (meters)",
    x = "Total RMS Error in X (meters)")+
...
```{r echo=FALSE}
wrap_plots(a1,a2,a3)+plot_annotation(title = '              Comparison between the Total XY RMS Error for the 3 Areas')+plot_annotation(tag_levels = c('1','1'))

```

```{r include=FALSE}
df <- data.frame(n = c("xRMSE", "yRMSE","dRMSE"), `Point1/Area1` = c(df1$X_RMSE, df1$Y_RMSE, sqrt(df1$X_RMSE^2+df1$Y_RMSE^2)), `Point2/Area1` = c(df2$X_RMSE, df2$Y_RMSE, sqrt(df2$X_RMSE^2+df2$Y_RMSE^2)), `Point3/Area1` = c(df3$X_RMSE,
...
```{r echo=FALSE}
df%>%
  kbl(caption = "Total Root Mean Square Error in (meteres)")%>%
...
```{r include=FALSE}
Pdop <- ggplot()+
  geom_point(data = PDOP_1, aes(x = "Area1", y = Point1, color = "Point1"),shape = 3)+
  geom_point(data = PDOP_1, aes(x = "Area1", y = Point2, color = "Point2"),shape = 3)+
  geom_point(data = PDOP_1, aes(x = "Area1", y = Point3, color = "Point3"),shape = 3)+
  geom_point(data = PDOP_2, aes(x = "Area2", y = Point1, color = "Point1"),shape = 3)+
  geom_point(data = PDOP_2, aes(x = "Area2", y = Point2, color = "Point2"),shape = 3)+
  geom_point(data = PDOP_2, aes(x = "Area2", y = Point3, color = "Point3"),shape = 3)+
  geom_point(data = PDOP_3, aes(x = "Area3", y = Point1, color = "Point1"),shape = 3)+
  geom_point(data = PDOP_3, aes(x = "Area3", y = Point2, color = "Point2"),shape = 3)+
  geom_point(data = PDOP_3, aes(x = "Area3", y = Point3, color = "Point3"),shape = 3)+
  theme_bw()+
  theme(
    text = element_text(size = 12, color = "black", face = "bold", family="Comic Sans MS"),
    axis.title.x  =  element_text(color = "blue", size = 12, face = "bold"),
    axis.title.y  =  element_text(color = "#993333", size = 12, face = "bold"))+
  labs(
    title = "                     Position Dilution of Precision Analysis",
