...
```{r warning=FALSE, include=FALSE}
setwd('/Users/anasosman/Downloads/dataexp1')
```

```{r Reading CSV files, include=FALSE}
file_paths <- fs::dir_ls("/Users/anasosman/Downloads/dataexp1")
file_paths
...
Area1<-data.frame(n = c("Areax","Areay"),"Point1" =  c(4.332+4.735, 1.785), "Point2" = c(2.448+4.735, 5.331), "Point3" = c(0.925+4.735, 8.904))
Area2<-data.frame(n = c("Areax","Areay"), "Point1" = c(4.332+4.735, 4.44),  "Point2" = c(2.448+4.735, 13.260),"Point3" = c(0.925+4.735, 22.148))
Area3<-data.frame(n = c("Areax","Areay"), "Point1" = c(4.332+4.735, 7.1),   "Point2" = c(2.448+4.735, 21.20), "Point3"  = c(0.925+4.735, 35.416))
```
...
```{r include=FALSE}
RMSE_Area1.1<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area11R1.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area11R2.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area11R3.csv`), Area1$Point1[1], Area1$Point1[2])
RMSE_Area1.2<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area12R1.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area12R2.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area12R3.csv`), Area1$Point2[1], Area1$Point2[2])
RMSE_Area1.3<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area13R1.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area13R2.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area13R3.csv`), Area1$Point3[1], Area1$Point3[2])
...
```{r include=FALSE}
RMSE_Area2.1<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area21R1.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area21R2.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area21R3.csv`), Area2$Point1[1], Area2$Point1[2])
RMSE_Area2.2<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area22R1.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area22R2.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area22R3.csv`), Area2$Point2[1], Area2$Point2[2])
RMSE_Area2.3<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area23R1.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area23R2.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area23R3.csv`), Area2$Point3[1], Area2$Point3[2])
```
...
```{r include=FALSE}
RMSE_Area3.1<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area31R1.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area31R2.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area31R3.csv`), Area3$Point1[1], Area3$Point1[2])
RMSE_Area3.2<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area32R1.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area32R2.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area32R3.csv`), Area3$Point2[1], Area3$Point2[2])
RMSE_Area3.3<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area33R1.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area33R2.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area33R3.csv`), Area3$Point3[1], Area3$Point3[2])
```
...
```{r include=FALSE}
##Area1
d1 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area11R1.csv`),mean)
d2 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area11R2.csv`),mean)
d3 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area11R3.csv`),mean)
df_list1 <- map_df(rbind(d1,d2,d3),mean)
d4 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area12R1.csv`),mean)
d5 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area12R2.csv`),mean)
d6 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area12R3.csv`),mean)
df_list2 <- map_df(rbind(d4,d5,d6),mean)
d7 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area13R1.csv`),mean)
d8 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area13R2.csv`),mean)
d9 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area13R3.csv`),mean)
df_list3 <- map_df(rbind(d7,d8,d9),mean)
```

```{r include=FALSE}
##Area2
d10 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area21R1.csv`),mean)
d11 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area21R2.csv`),mean)
d12<- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area21R3.csv`),mean)
df_list4 <- map_df(rbind(d10,d11,d12),mean)
d13 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area22R1.csv`),mean)
d14 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area22R2.csv`),mean)
d15 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area22R3.csv`),mean)
df_list5 <- map_df(rbind(d13,d14,d15),mean)
d16 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area23R1.csv`),mean)
d17 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area23R2.csv`),mean)
d18 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area23R3.csv`),mean)
df_list6 <- map_df(rbind(d16,d17,d18),mean)
```

```{r include=FALSE}
##Area3
d19 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area31R1.csv`),mean)
d20 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area31R2.csv`),mean)
d21 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area31R3.csv`),mean)
df_list7 <- map_df(rbind(d19,d20,d21),mean)
d22 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area32R1.csv`),mean)
d23 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area32R2.csv`),mean)
d24 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area32R3.csv`),mean)
df_list8 <- map_df(rbind(d22,d23,d24),mean)
d25 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area33R1.csv`),mean)
d26 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area33R2.csv`),mean)
d27 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp1/Area33R3.csv`),mean)
