...
file_paths <- fs::dir_ls("/home/anas/Music/data/data")
file_paths
...
```{r include=FALSE}
df1<-file_contents$`/home/anas/Music/data/data/Area11R1.csv`
df2<-file_contents$`/home/anas/Music/data/data/Area11R2.csv`
df3<-file_contents$`/home/anas/Music/data/data/Area11R3.csv`
df4<-file_contents$`/home/anas/Music/data/data/Area12R1.csv`
df5<-file_contents$`/home/anas/Music/data/data/Area12R2.csv`
df6<-file_contents$`/home/anas/Music/data/data/Area12R3.csv`
df7<-file_contents$`/home/anas/Music/data/data/Area13R1.csv`
df8<-file_contents$`/home/anas/Music/data/data/Area13R2.csv`
df9<-file_contents$`/home/anas/Music/data/data/Area13R3.csv`
######################################################
df10<-file_contents$`/home/anas/Music/data/data/Area21R1.csv`
df11<-file_contents$`/home/anas/Music/data/data/Area21R2.csv`
df12<-file_contents$`/home/anas/Music/data/data/Area21R3.csv`
df13<-file_contents$`/home/anas/Music/data/data/Area22R1.csv`
df14<-file_contents$`/home/anas/Music/data/data/Area22R2.csv`
df15<-file_contents$`/home/anas/Music/data/data/Area22R3.csv`
df16<-file_contents$`/home/anas/Music/data/data/Area23R1.csv`
df17<-file_contents$`/home/anas/Music/data/data/Area23R2.csv`
df18<-file_contents$`/home/anas/Music/data/data/Area23R3.csv`
#####################################################
df19<-file_contents$`/home/anas/Music/data/data/Area31R1.csv`
df20<-file_contents$`/home/anas/Music/data/data/Area31R2.csv`
df21<-file_contents$`/home/anas/Music/data/data/Area31R3.csv`
df22<-file_contents$`/home/anas/Music/data/data/Area32R1.csv`
df23<-file_contents$`/home/anas/Music/data/data/Area32R2.csv`
df24<-file_contents$`/home/anas/Music/data/data/Area32R3.csv`
df25<-file_contents$`/home/anas/Music/data/data/Area33R1.csv`
df26<-file_contents$`/home/anas/Music/data/data/Area33R2.csv`
df27<-file_contents$`/home/anas/Music/data/data/Area33R3.csv`
```
...
wx <- ggplot(data=f)+
  geom_point(aes(x="1", y=p1[1],color="Position1RMSE"),shape=4)+
  geom_point(aes(x="1", y=p4[1],color="Position1RMSE"),shape=4)+
  geom_point(aes(x="1", y=p7[1],color="Position1RMSE"),shape=4)+
  geom_point(aes(x="2", y=p2[1],color="Position2RMSE"),shape=4)+
  geom_point(aes(x="2", y=p5[1],color="Position2RMSE"),shape=4)+
  geom_point(aes(x="2", y=p8[1],color="Position2RMSE"),shape=4)+
  geom_point(aes(x="3", y=p3[1],color="Position3RMSE"),shape=4)+
  geom_point(aes(x="3", y=p6[1],color="Position3RMSE"),shape=4)+
  geom_point(aes(x="3", y=p9[1],color="Position3RMSE"),shape=4)+
  theme_bw()+
  scale_color_manual(
    labels = c("Position1RMSE","Position2RMSE", "Position3RMSE"),
...
wy <- ggplot(data=f)+
  geom_point(aes(x="1", y=p1[2],color="Position1RMSE"),shape=4)+
  geom_point(aes(x="1", y=p4[2],color="Position1RMSE"),shape=4)+
  geom_point(aes(x="1", y=p7[2],color="Position1RMSE"),shape=4)+
  geom_point(aes(x="2", y=p2[2],color="Position2RMSE"),shape=4)+
  geom_point(aes(x="2", y=p5[2],color="Position2RMSE"),shape=4)+
  geom_point(aes(x="2", y=p8[2],color="Position2RMSE"),shape=4)+
  geom_point(aes(x="3", y=p3[2],color="Position3RMSE"),shape=4)+
  geom_point(aes(x="3", y=p6[2],color="Position3RMSE"),shape=4)+
  geom_point(aes(x="3", y=p9[2],color="Position3RMSE"),shape=4)+
  theme_bw()+
...
k <-ggplot()+
  geom_point(data = she, aes(x=h1[1],y=h1[2], color= "Area1"),shape=1)+
  geom_point(data = she, aes(x=h2[1],y=h2[2], color= "Area2"),shape=1)+
  geom_point(data = she, aes(x=h3[1],y=h3[2], color= "Area3"),shape=1)+
  geom_point(data = she1, aes(x=h1[1],y=h1[2], color="Area1"),shape=1)+
  geom_point(data = she1, aes(x=h2[1],y=h2[2], color="Area2"),shape=1)+
  geom_point(data = she1, aes(x=h3[1],y=h3[2], color="Area3"),shape=1)+
  geom_point(data = she2, aes(x=h1[1],y=h1[2], color="Area1"),shape=1)+
  geom_point(data = she2, aes(x=h2[1],y=h2[2], color="Area2"),shape=1)+
  geom_point(data = she2, aes(x=h3[1],y=h3[2], color="Area3"),shape=1)+
  geom_point(data = sha, aes(x=h1[1],y=h1[2] , color="Area1"),shape=3)+
  geom_point(data = sha, aes(x=h2[1],y=h2[2] , color="Area2"),shape=3)+
  geom_point(data = sha, aes(x=h3[1],y=h3[2] , color="Area3"),shape=3)+
  geom_point(data = sha1, aes(x=h1[1],y=h1[2], color="Area1"),shape=3)+
  geom_point(data = sha1, aes(x=h2[1],y=h2[2], color="Area2"),shape=3)+
  geom_point(data = sha1, aes(x=h3[1],y=h3[2], color="Area3"),shape=3)+
  geom_point(data = sha2, aes(x=h1[1],y=h1[2], color="Area1"),shape=3)+
  geom_point(data = sha2, aes(x=h2[1],y=h2[2], color="Area2"),shape=3)+
  geom_point(data = sha2, aes(x=h3[1],y=h3[2], color="Area3"),shape=3)+
  theme_bw()+
  scale_color_manual(
    values = c("red","black","blue"))+ 
  guides(color = guide_legend("Legend"))+
...
library(plotly)
ggplotly(k)%>% config(displayModeBar = F)
```
...
wrap_plots(bp,bp2,bp3)+  plot_annotation(title = '               Exp1 Comparison between the Total XY RMS Error for the 3 Areas')+ plot_annotation(tag_levels = c('1','1'))
...
```{r echo=FALSE}
ggplotly(n11, tooltip = "non") %>% config(displayModeBar = F)
```
