...
```{r warning=FALSE, include=FALSE}
setwd('/Users/anasosman/Downloads/dataexp2')
```

```{r Reading CSV files, include=FALSE}
file_paths <- fs::dir_ls("/Users/anasosman/Downloads/dataexp2")
file_paths
...
Area1<-data.frame(n = c("Areax","Areay"),"Point1" =  c(4.332, 1.785), "Point2" = c(2.448, 5.331), "Point3" = c(0.925, 8.904))
Area2<-data.frame(n = c("Areax","Areay"), "Point1" = c(4.332, 4.44),  "Point2" = c(2.448, 13.260),"Point3" = c(0.925, 22.148))
Area3<-data.frame(n = c("Areax","Areay"), "Point1" = c(4.332, 7.1),   "Point2" = c(2.448, 21.20), "Point3"  = c(0.925, 35.416))
```
...
```{r include=FALSE}
RMSE_Area1.1<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R11.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R12.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R13.csv`), Area1$Point1[1], Area1$Point1[2])
RMSE_Area1.2<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R21.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R22.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R23.csv`), Area1$Point2[1], Area1$Point2[2])
RMSE_Area1.3<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R31.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R32.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R33.csv`), Area1$Point3[1], Area1$Point3[2])
...
```{r include=FALSE}
RMSE_Area2.1<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R11.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R12.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R13.csv`), Area2$Point1[1], Area2$Point1[2])
RMSE_Area2.2<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R21.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R22.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R23.csv`), Area2$Point2[1], Area2$Point2[2])
RMSE_Area2.3<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R31.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R32.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R33.csv`), Area2$Point3[1], Area2$Point3[2])
```
...
```{r include=FALSE}
RMSE_Area3.1<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R11.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R12.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R13.csv`), Area3$Point1[1], Area3$Point1[2])
RMSE_Area3.2<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R21.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R22.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R23.csv`), Area3$Point2[1], Area3$Point2[2])
RMSE_Area3.3<- Data_clean(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R31.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R32.csv`),clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R33.csv`), Area3$Point3[1], Area3$Point3[2])
```
...
```{r include=FALSE}
##Area1
d1 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R11.csv`),mean)
d2 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R12.csv`),mean)
d3 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R13.csv`),mean)
df_list1 <- map_df(rbind(d1,d2,d3),mean)
d4 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R21.csv`),mean)
d5 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R22.csv`),mean)
d6 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R23.csv`),mean)
df_list2 <- map_df(rbind(d4,d5,d6),mean)
d7 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R31.csv`),mean)
d8 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R32.csv`),mean)
d9 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area1R33.csv`),mean)
df_list3 <- map_df(rbind(d7,d8,d9),mean)
```

```{r include=FALSE}
##Area2
d10 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R11.csv`),mean)
d11 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R12.csv`),mean)
d12<- map_df( clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R13.csv`),mean)
df_list4 <- map_df(rbind(d10,d11,d12),mean)
d13 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R21.csv`),mean)
d14 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R22.csv`),mean)
d15 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R23.csv`),mean)
df_list5 <- map_df(rbind(d13,d14,d15),mean)
d16 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R31.csv`),mean)
d17 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R32.csv`),mean)
d18 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area2R33.csv`),mean)
df_list6 <- map_df(rbind(d16,d17,d18),mean)
```

```{r include=FALSE}
##Area3
d19 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R11.csv`),mean)
d20 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R12.csv`),mean)
d21 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R13.csv`),mean)
df_list7 <- map_df(rbind(d19,d20,d21),mean)
d22 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R21.csv`),mean)
d23 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R22.csv`),mean)
d24 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R23.csv`),mean)
df_list8 <- map_df(rbind(d22,d23,d24),mean)
d25 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R31.csv`),mean)
d26 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R32.csv`),mean)
d27 <- map_df(clean(file_contents$`/Users/anasosman/Downloads/dataexp2/Area3R33.csv`),mean)
...
```{r echo=FALSE}
names(df) <- c("n","Point1.AreaSmall", "Point2.AreaSmall", "Point3.AreaSmall" ,"Point1.AreaMedium", "Point2.AreaMedium", "Point3.AreaMedium", "Point1.AreaLarge", "Point2.AreaLarge" ,"Point3.AreaLarge")
df%>%
...
```{r include=FALSE}
PDOP_1<- data.frame(Point1 = 3.0397,Point2 = 7.4488, Point3 = 28.0015)
PDOP_2<- data.frame(Point1 = 3.7677, Point2= 4.108, Point3= 2.206)
PDOP_3<- data.frame(Point1 =5.799, Point2= 8.963, Point3= 13.202)
```
